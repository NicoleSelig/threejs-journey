...
// Uses for a ray caster
//detect a wall in front of the player
// test if the laser gun is hitting something
...
window.addEventListener('mousemove', (event) => {
    mouse.x = event.clientX / sizes.width * 2 - 1 //for normalized value
    mouse.y = -(event.clientY / sizes.height) * 2 + 1 // for normalized value
})
